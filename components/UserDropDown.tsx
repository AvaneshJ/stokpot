    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild className="hover:bg-gray-600">
        ...
        >
          <Avatar className="h-8 w-8">
            <AvatarImage src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8hUz-P7Cz2ZKn2DEN_EvFhjwmRiURX7r9TA&s" />
      ...
      <DropdownMenuContent className="text-gray-400 bg-gray-700 ">
        ...
        <DropdownMenuItem
          ...
          className="text-md text-gray-100 font-medium focus:bg-transparent focus:text-yellow-500 cursor-pointer transition-colors"
        >
